 ...
 * @author dmknopp
 */
public class EchoWebEventListener implements UpdateListener {
	protected Logger logger = LoggerFactory.getLogger(EchoWebEventListener.class);
